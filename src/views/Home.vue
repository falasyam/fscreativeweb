<template>
  <div class="section" id="home">
        ...
        >
            ...
            <v-col cols="8" md="8" lg="8" xs="8" sm="12" class="">
                <span class="display-3 font-weight-bold " justify="center">
                We Are Creative Service Provider.
                </span>
            </v-col>
            <v-col cols="12" md="4" lg="4" xs="4" sm="12" class="pa-2 hidden-sm-and-down">
                <v-img class="pa-4 ma-3" :src='require("../assets/illustrasi1.png")'/>
                <p class="text--disabled" justify="center" align="center">Illustration by <a href="https://www.manypixels.co/">ManyPixel</a></p>
            </v-col>
            </v-row>
            <div class="py-12"></div>
        </v-container>
